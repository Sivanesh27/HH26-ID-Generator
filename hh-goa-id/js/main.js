...
(function () {
  ...
  async function shareCardToX(node, member, triggerBtn) {
    // Open the tab synchronously (before any await) so mobile/desktop
    // popup blockers don't swallow it — we navigate it once we're ready.
    ...
    try {
      ...
      showToast("Opening X — your badge will show as the link preview.");
    } catch (err) {
      console.error("share failed:", err);
      showToast("Couldn't prepare a live preview — downloading your ID so you can attach it manually.");
